...
> 2026-09-06、個別監査済み567問の公開反映を承認しました。公式教材本文との網羅性と実学習者の効果は未検証です。公開承認と合格・網羅性の保証を区別しています。既存DBの再構築は行わず、通常の同期を使ってください。[監査記録と公開判断](docs/audit/2026-09-05/README.md) を参照してください。
...
- 2級学習向けに再監査中の567問（通常学習447問＋初見模試用120問）
- 通常学習の合格コア185問を優先する1日最大10問の新規学習目標
...
全567問を一つの正本で管理します。初見性を守るため模試採用120問は通常レッスンへ事前配信せず、その模試の採点後に復習・弱点レッスンへ解放します。各問の解答後には論点別の関連する公式資料を表示します。自動検証の範囲と一次資料は [docs/content-sources.md](docs/content-sources.md)、定期改訂の手順は [docs/content-review-policy.md](docs/content-review-policy.md) を参照してください。

        ...
        >
            <div class="flex items-start justify-between gap-3">
                ...
                <div
                    ...
                    :class="[
                        'shrink-0 rounded-md px-3 py-2 text-center',
            ...
            <div class="my-4 grid grid-cols-3 gap-2 text-center text-xs">
                <div class="rounded-xl bg-gray-50 p-2 dark:bg-gray-800">
                    <Clock3 class="mx-auto mb-1 size-4 text-[#2864f0]" />{{
            ...
            <div
                ...
                class="mb-4 flex h-12 items-end gap-1 rounded-xl bg-gray-50 px-2 pt-2 dark:bg-gray-800"
            >
                <div
                    v-for="(score, i) in exam.scores"
                    :key="i"
                    class="flex-1 rounded-t bg-blue-300"
            ...
            <Link
                ...
                class="flex w-full items-center justify-center gap-2 rounded-md bg-[#2864f0] py-3 font-semibold text-white shadow-sm"
                ><RotateCcw class="size-4" />途中から再開</Link
            >
            <div v-else class="grid grid-cols-2 gap-3">
                <button
                    :disabled="starting === exam.id"
                    class="flex items-center justify-center gap-1 rounded-md bg-[#2864f0] py-3 text-sm font-semibold text-white shadow-sm active:shadow-none"

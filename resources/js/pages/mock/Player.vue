...
<template>
    ...
    <div class="flex min-h-dvh flex-col bg-stone-50 dark:bg-stone-950">
        <header
            class="sticky top-0 z-20 border-b bg-white dark:border-stone-800 dark:bg-stone-900"
        >
            <div class="mx-auto flex h-14 max-w-5xl items-center gap-3 px-3">
                ...
                /></a>
                <p
                    class="hidden flex-1 truncate text-sm font-extrabold text-stone-700 sm:block dark:text-stone-100"
                >
                    {{ attempt.name }}
                </p>
        ...
        >
            <div>
                <div
                    class="mb-3 flex items-center justify-between text-xs font-bold text-stone-400"
                >
                    <span
                ...
                <div
                    v-if="calculatorOpen"
                    class="mt-3 rounded-2xl border-2 border-amber-100 bg-white p-3 dark:border-stone-800 dark:bg-stone-900"
                >
                    ...
                    <p
                        v-if="calcResult"
                        class="mt-2 text-right text-lg font-extrabold text-amber-600"
                    >
                        {{ calcResult }}
                    </p>
                </div>
                ...
                >
                    <button
                        ...
                        :key="choice.key"
                        :class="[
                            'flex w-full items-start gap-3 rounded-2xl border-2 bg-white p-3.5 text-left text-sm transition dark:bg-stone-900',
                ...
                <div
                    v-else
                    class="mt-4 rounded-2xl border-2 border-stone-200 bg-white p-4 dark:border-stone-700 dark:bg-stone-900"
                >
                    <label class="mb-2 block text-xs font-bold text-stone-400"
                        >解答（数値）</label
                    ><input
                        :value="answers[String(current.id)] ?? ''"
                        inputmode="numeric"
                        class="w-full rounded-xl border-2 border-stone-200 px-4 py-3 text-lg font-bold focus:border-violet-500 focus:outline-none dark:border-stone-700 dark:bg-stone-800"
                        @input="
                ...
                <div class="mt-5 flex justify-between">
                    ...
                    ><button
                        ...
                        class="flex items-center rounded-xl bg-violet-500 px-5 py-2 text-sm font-bold text-white"
                        @click="go(index + 1)"
                    >
            ...
            <aside
                class="hidden rounded-3xl border-2 border-stone-100 bg-white p-4 md:block dark:border-stone-800 dark:bg-stone-900"
            >
                <div class="mb-3 flex justify-between">
                    <h2 class="font-extrabold">解答状況</h2>
                ...
                <div class="grid grid-cols-5 gap-2">
                    <button
                        ...
                        :class="[
                            ...
                            i === index ? 'ring-2 ring-violet-500' : '',
                ...
                <button
                    class="mt-5 w-full rounded-xl bg-rose-500 py-2.5 text-sm font-extrabold text-white"
                    @click="sheetOpen = true"
                >
                    採点する
                </button>
        ...
        <nav
            class="fixed inset-x-0 bottom-0 border-t bg-white p-3 md:hidden dark:border-stone-800 dark:bg-stone-900"
        >
            <button
                class="mx-auto flex items-center gap-2 rounded-xl bg-violet-500 px-5 py-2.5 text-sm font-extrabold text-white"
                @click="sheetOpen = true"
            >
        ...
        >
            <div
                class="w-full max-w-md rounded-3xl bg-white p-5 dark:bg-stone-900"
            >
                <h2 class="text-lg font-extrabold">提出しますか？</h2>
                ...
                <div class="mt-4 grid grid-cols-2 gap-3">
                    ...
                    ><button
                        :disabled="finishing"
                        class="rounded-xl bg-rose-500 py-3 font-extrabold text-white"
                        @click="finish"
                    >

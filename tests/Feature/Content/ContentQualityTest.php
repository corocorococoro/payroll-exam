...
test('解答画面用の根拠資料は公式httpsだけを返す', function () {
    ...
    expect($sources)->not->toBeEmpty()
        ...
        ->toContain('日本年金機構：育児休業等の月額・賞与保険料免除');
});
...
test('監査は通常学習問題がゼロになるレッスンを検出する', function () {
    $question = Question::where('source_id', 'q-0684')->firstOrFail();

...
class GamificationSeeder extends Seeder
{
    public function run(): void
    {
        $badges = [
            ...
            ['slug' => 'streak-7', 'name' => '一週間継続', 'description' => '7日ストリークを達成した', 'icon' => '🔥'],
            ['slug' => 'streak-30', 'name' => '習慣の達人', 'description' => '30日ストリークを達成した', 'icon' => '🏃'],
            ['slug' => 'streak-100', 'name' => '継続の神様', 'description' => '100日ストリークを達成した', 'icon' => '👑'],
            ['slug' => 'lesson-master', 'name' => 'クラウンマスター', 'description' => 'レッスンをクラウン5にした', 'icon' => '🏆'],
            ['slug' => 'mock-pass', 'name' => '合格ライン突破', 'description' => '模試で70点以上を獲得した', 'icon' => '🎉'],
            ['slug' => 'mock-80', 'name' => '安定合格圏', 'description' => '模試で80点以上を獲得した', 'icon' => '🥇'],
